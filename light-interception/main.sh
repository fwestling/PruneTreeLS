...
main $1 $binary $fields $weather_file $latitude $longitude $utc_offset $start_date $end_date $step_dates $step_hours $voxel_size "($(echo $transmittance | tr ':' ' '))" $sphere_repeats $write_file $mask_file $single_time
