...
| csv-select --binary=3i,3d,ui --fields=vx,vy,vz,x,y,z,w "w;greater=$velo_wtresh" "x;from=7219019;to=7219025" "y;from=437225.5;to=437232.5" "z;from=-90" \
> velo_voxelised.bin

cat $zeb | points-frame --binary=$zeb_bin --fields=$zeb_fields --from=$(csv-paste "$corr_points_velo" "$corr_points_zeb" | points-align) \
| points-to-voxels --binary=$zeb_bin --fields=$zeb_fields --resolution=$voxel_res --origin=0,0,0 \
| csv-select --binary=3i,3d,ui --fields=vx,vy,vz,x,y,z,w "w;greater=$zeb_wtresh" "x;from=7219019;to=7219025" "y;from=437225.5;to=437232.5" "z;from=-90" \
> zeb_voxelised.bin
...
c_start=500
c_end=1000
view-points "zeb_voxelised.bin;binary=3i,3d,ui;fields=x,y,z,,,scalar;colour=-89:-85,jet" \
"velo_voxelised.bin;binary=3i,3d,ui;fields=x,y,z,,,scalar;colour=-89:-85,jet" \
"only_zeb.bin;binary=3i,3d,ui;fields=x,y,z,,,scalar;colour=-89:-85,jet" \
"only_velo.bin;binary=3i,3d,ui;fields=x,y,z,,,scalar;colour=-89:-85,jet" \
"zeb_and_velo.bin;binary=3i,3d,ui;fields=x,y,z,,,scalar;colour=-89:-85,jet" \
"normw_zeb.bin;binary=3i,3d,ui,d;fields=x,y,z,,,,,scalar;colour=0:3,hot" \
"normw_velo.bin;binary=3i,3d,ui,d;fields=x,y,z,,,,,scalar;colour=0:3,hot"